## [1.1 大型微服务框架设计实践 - 杜欢](./assets/2019-04-27/pdf/1.1 大型微服务框架设计实践 - 杜欢.pdf)
...
## [1.2 用Go打造Grab的路径规划和ETA引擎](./assets/2019-04-27/pdf/1.2 用Go打造Grab的路径规划和ETA引擎.pdf)
...
![司机定位-gps误差](./assets/2019-04-27/img/02 司机定位-gps误差.jpg)
![02 司机定位 - gps误差](./assets/2019-04-27/img/02 司机定位 - gps误差.jpg)
![司机定位- Map Matching \(HMM\)](./assets/2019-04-27/img/02 司机定位- Map Matching%28HMM%29.jpg)
...
## [1.3 Go practices in TiDB - 姚维](./assets/2019-04-27/pdf/1.3 Go practices in TiDB - 姚维.pdf)
...
![1.3 Row formt in TiDB](./assets/2019-04-27/img/1.3 Row formt in TiDB.jpg)

![1.3 Chunk](./assets/2019-04-27/img/1.3 Chunk.jpg)
...
## [1.4 Testing; how, what, why - Dave ](./assets/2019-04-27/pdf/1.4 Testing; how, what, why - Dave .pdf)
...
## [1.5 Go 业务开发中 Error & Context - 毛剑](./assets/2019-04-27/pdf/1.5 Go 业务开发中 Error & Context - 毛剑.pdf)
...
![1.5 Error-Best Pratice](./assets/2019-04-27/img/1.5 Error-Best Pratice.jpg)

![1.5 Error-Best Pratice code](./assets/2019-04-27/img/1.5 Error-Best Pratice code.jpg)

[Google APIs的错误模型](https://google-cloud.gitbook.io/api-design-guide/errors)

**Context**
􏰭􏰇􏰊􏰏􏰦􏰘􏰤􏰻􏰠􏰭
![](./assets/2019-04-27/img/1.5 Context With API.jpg)
![](./assets/2019-04-27/img/1.5 Context - Best Pratice.jpg)
...
## [1.6 Go并发编程实践 - 晁岳攀](./assets/2019-04-27/pdf/1.6 Go并发编程实践 - 晁岳攀.pdf)
...
## [1.7 百度APP Go 语言实践 - 陈肖楠](./assets/2019-04-27/pdf/1.7 百度APP Go 语言实践 - 陈肖楠.pdf)

---

**工程能力评估图**

![开发规范](./assets/2019-04-27/img/1.7 开发规范.jpg)
...
## [1.8 Golang to build a real-time interactive SaaS Cloud - 董海冰](./assets/2019-04-27/pdf/1.8 Golang to build a real-time interactive SaaS Cloud - 董海冰.pdf)
